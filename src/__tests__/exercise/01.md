...
1. Test isolation: Always make sure to cleanup after each test use beforeEach()
2. Test yout Tests: After we write test, updae your component to make sure test
   fails - to check if test is working or not
3. How would manual tester will test and try to automate it - that is how you
   should test React Apps
