...
1. Abstraction: Following things got abstracted, i. Creating div and attaching
   to DOM using render method ii. Creating Mouseevenet and dispatching it using
   fireEvent iii. Instead of expect().to.Be, use jest-dom toHaveTextContent
   method
